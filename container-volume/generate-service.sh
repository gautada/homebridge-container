#!/bin/ash
# FROM: https://github.com/dhutchison/container-images
# FROM: https://www.devwithimagination.com/2020/02/02/running-homebridge-on-docker-without-host-network-mode/
set -euo pipefail
IFS=$'\n\t'
